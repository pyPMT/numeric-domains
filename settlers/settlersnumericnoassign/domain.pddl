...
(define (domain civ)
     ...
     (:action unload1
          :parameters (?v - vehicle ?p - place ?r - resource)
          :precondition (and (is-at ?v ?p) (>= (available ?r ?v) 1))
     ...
     (:action build-mine1
          ...
          :effect (and (increase (labour) 3) (decrease (available wood ?p) 2) (has-mine ?p))
     )
     (:action build-ironworks1
          :parameters (?p - place)
     ...
     (:action build-docks1
          :parameters (?p - place)
          :precondition (and (by-coast ?p) (>= (available stone ?p) 2) (>= (available wood ?p) 2))
     ...
     (:action build-wharf1
          :parameters (?p - place)
          :precondition (and (has-docks ?p) (>= (available stone ?p) 2) (>= (available iron ?p) 2))
          :effect (and (decrease (available stone ?p) 2)
     ...
     (:action saw-wood1
          ...
          :effect (and (decrease (available timber ?p) 1) (increase (available wood ?p) 1))
     )
     (:action make-iron1
          :parameters (?p - place)
          :precondition (and (has-ironworks ?p) (>= (available ore ?p) 1) (>= (available coal ?p) 2))
