; Solution sequence: left up right up left down left up left
(define (problem pfile9)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 0) (= (value p12) 32) (= (value p13) 64) (= (value p14) 256)
        (= (value p21) 32) (= (value p22) 128) (= (value p23) 32) (= (value p24) 32)
        (= (value p31) 8) (= (value p32) 8) (= (value p33) 16) (= (value p34) 64)
        (= (value p41) 128) (= (value p42) 128) (= (value p43) 64) (= (value p44) 32)
    )
