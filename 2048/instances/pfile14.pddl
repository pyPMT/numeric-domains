; Solution sequence: down up left down left up right up left down right up up left
(define (problem pfile14)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 0) (= (value p12) 16) (= (value p13) 256) (= (value p14) 16)
        (= (value p21) 256) (= (value p22) 64) (= (value p23) 64) (= (value p24) 0)
        (= (value p31) 16) (= (value p32) 64) (= (value p33) 64) (= (value p34) 16)
        (= (value p41) 64) (= (value p42) 64) (= (value p43) 64) (= (value p44) 0)
    )
