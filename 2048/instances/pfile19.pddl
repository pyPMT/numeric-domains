; Solution sequence: up right up left down right up right down right down left down right up left left up left
(define (problem pfile19)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 16) (= (value p12) 32) (= (value p13) 16) (= (value p14) 256)
        (= (value p21) 128) (= (value p22) 256) (= (value p23) 2048) (= (value p24) 256)
        (= (value p31) 512) (= (value p32) 32) (= (value p33) 64) (= (value p34) 128)
        (= (value p41) 16) (= (value p42) 64) (= (value p43) 16) (= (value p44) 256)
    )
