; Solution sequence: down left up right up left down right up left up right down left up right up right up left left
(define (problem pfile21)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 0) (= (value p12) 0) (= (value p13) 512) (= (value p14) 0)
        (= (value p21) 512) (= (value p22) 0) (= (value p23) 32) (= (value p24) 0)
        (= (value p31) 2048) (= (value p32) 256) (= (value p33) 0) (= (value p34) 64)
        (= (value p41) 64) (= (value p42) 32) (= (value p43) 512) (= (value p44) 64)
    )
