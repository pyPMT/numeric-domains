; Solution sequence: up right down left up up right down right up up right down left up left left left
(define (problem pfile18)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 8) (= (value p12) 4) (= (value p13) 32) (= (value p14) 128)
        (= (value p21) 4) (= (value p22) 512) (= (value p23) 32) (= (value p24) 64)
        (= (value p31) 4) (= (value p32) 32) (= (value p33) 64) (= (value p34) 8)
        (= (value p41) 32) (= (value p42) 4) (= (value p43) 64) (= (value p44) 32)
    )
