; Solution sequence: down right up left down right up left up right down left right up left down left left up right down left down left up
(define (problem pfile25)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 8) (= (value p12) 256) (= (value p13) 8) (= (value p14) 256)
        (= (value p21) 512) (= (value p22) 32) (= (value p23) 32) (= (value p24) 16)
        (= (value p31) 256) (= (value p32) 2048) (= (value p33) 32) (= (value p34) 32)
        (= (value p41) 0) (= (value p42) 32) (= (value p43) 512) (= (value p44) 64)
    )

    (:goal (and
        (= (value p11) 4096) (= (value p12) 0) (= (value p13) 0) (= (value p14) 0)
