; Solution sequence: up left down left up left down left up right down left down left up right down left left up down left up
(define (problem pfile23)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 128) (= (value p12) 4) (= (value p13) 64) (= (value p14) 32)
        (= (value p21) 16) (= (value p22) 32) (= (value p23) 16) (= (value p24) 64)
        (= (value p31) 32) (= (value p32) 32) (= (value p33) 512) (= (value p34) 4)
        (= (value p41) 4) (= (value p42) 16) (= (value p43) 4) (= (value p44) 64)
    )

    (:goal (and
        (= (value p11) 1024) (= (value p12) 0) (= (value p13) 0) (= (value p14) 0)
