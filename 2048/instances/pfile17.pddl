; Solution sequence: up down left right up left down right up right down left down right up up left
(define (problem pfile17)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 0) (= (value p12) 64) (= (value p13) 128) (= (value p14) 8)
        (= (value p21) 8) (= (value p22) 0) (= (value p23) 256) (= (value p24) 32)
        (= (value p31) 256) (= (value p32) 32) (= (value p33) 16) (= (value p34) 16)
        (= (value p41) 64) (= (value p42) 64) (= (value p43) 64) (= (value p44) 16)
    )
