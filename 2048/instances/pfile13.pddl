; Solution sequence: up left down left up left right up right up up left left
(define (problem pfile13)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 64) (= (value p12) 32) (= (value p13) 32) (= (value p14) 256)
        (= (value p21) 2048) (= (value p22) 128) (= (value p23) 64) (= (value p24) 128)
        (= (value p31) 2048) (= (value p32) 256) (= (value p33) 1024) (= (value p34) 1024)
        (= (value p41) 0) (= (value p42) 1024) (= (value p43) 32) (= (value p44) 32)
    )
