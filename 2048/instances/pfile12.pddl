; Solution sequence: down down left up right down left up left up up left
(define (problem pfile12)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 32) (= (value p12) 64) (= (value p13) 16) (= (value p14) 8)
        (= (value p21) 32) (= (value p22) 16) (= (value p23) 16) (= (value p24) 32)
        (= (value p31) 8) (= (value p32) 32) (= (value p33) 32) (= (value p34) 32)
        (= (value p41) 64) (= (value p42) 32) (= (value p43) 64) (= (value p44) 32)
    )
