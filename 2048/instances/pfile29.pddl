; Solution sequence: left up right down left down left up right down left up right down left up right down left up left down right up left up left up up
(define (problem pfile29)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 0) (= (value p12) 128) (= (value p13) 0) (= (value p14) 8)
        (= (value p21) 512) (= (value p22) 0) (= (value p23) 0) (= (value p24) 128)
        (= (value p31) 128) (= (value p32) 32) (= (value p33) 8) (= (value p34) 1024)
        (= (value p41) 0) (= (value p42) 64) (= (value p43) 8) (= (value p44) 8)
    )

    (:goal (and
        (= (value p11) 2048) (= (value p12) 0) (= (value p13) 0) (= (value p14) 0)
