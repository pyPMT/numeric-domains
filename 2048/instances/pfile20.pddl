; Solution sequence: up left up down right up left up left down right up up left up right up up left left
(define (problem pfile20)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 32) (= (value p12) 2048) (= (value p13) 256) (= (value p14) 1024)
        (= (value p21) 256) (= (value p22) 64) (= (value p23) 1024) (= (value p24) 512)
        (= (value p31) 256) (= (value p32) 128) (= (value p33) 512) (= (value p34) 256)
        (= (value p41) 256) (= (value p42) 32) (= (value p43) 1024) (= (value p44) 512)
    )
