; Solution sequence: up left down right down left left up
(define (problem pfile8)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 4) (= (value p12) 0) (= (value p13) 32) (= (value p14) 2)
        (= (value p21) 4) (= (value p22) 0) (= (value p23) 2) (= (value p24) 0)
        (= (value p31) 0) (= (value p32) 32) (= (value p33) 0) (= (value p34) 0)
        (= (value p41) 32) (= (value p42) 4) (= (value p43) 0) (= (value p44) 16)
    )
