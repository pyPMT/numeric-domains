; Solution sequence: left down left right up left down left up right down left up up up left
(define (problem pfile16)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 16) (= (value p12) 0) (= (value p13) 0) (= (value p14) 0)
        (= (value p21) 2) (= (value p22) 64) (= (value p23) 4) (= (value p24) 2)
        (= (value p31) 0) (= (value p32) 16) (= (value p33) 0) (= (value p34) 16)
        (= (value p41) 4) (= (value p42) 0) (= (value p43) 2) (= (value p44) 2)
    )

    (:goal (and
        (= (value p11) 128) (= (value p12) 0) (= (value p13) 0) (= (value p14) 0)
