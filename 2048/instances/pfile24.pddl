; Solution sequence: right up right down left down right down right up left down right up up left down right up right up right up left
(define (problem pfile24)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 128) (= (value p12) 32) (= (value p13) 0) (= (value p14) 0)
        (= (value p21) 2048) (= (value p22) 64) (= (value p23) 2048) (= (value p24) 1024)
        (= (value p31) 2048) (= (value p32) 128) (= (value p33) 0) (= (value p34) 256)
        (= (value p41) 32) (= (value p42) 256) (= (value p43) 0) (= (value p44) 128)
    )
