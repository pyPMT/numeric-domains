; Solution sequence: up right up left down right up left down left up up left left up
(define (problem pfile15)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 4) (= (value p12) 16) (= (value p13) 0) (= (value p14) 32)
        (= (value p21) 0) (= (value p22) 0) (= (value p23) 16) (= (value p24) 16)
        (= (value p31) 16) (= (value p32) 8) (= (value p33) 32) (= (value p34) 0)
        (= (value p41) 16) (= (value p42) 64) (= (value p43) 32) (= (value p44) 4)
    )

    (:goal (and
        (= (value p11) 256) (= (value p12) 0) (= (value p13) 0) (= (value p14) 0)
