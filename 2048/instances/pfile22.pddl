; Solution sequence: right down left down right up left up right down right up left down left up up right up left left up
(define (problem pfile22)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 2) (= (value p12) 32) (= (value p13) 16) (= (value p14) 64)
        (= (value p21) 64) (= (value p22) 8) (= (value p23) 128) (= (value p24) 8)
        (= (value p31) 4) (= (value p32) 32) (= (value p33) 4) (= (value p34) 128)
        (= (value p41) 2) (= (value p42) 4) (= (value p43) 8) (= (value p44) 8)
    )

    (:goal (and
        (= (value p11) 512) (= (value p12) 0) (= (value p13) 0) (= (value p14) 0)
