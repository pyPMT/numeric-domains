; Solution sequence: up left left up left right up up up left
(define (problem pfile10)
    ...
    (:init
        ...
        ;; ---- Tile values ----
        (= (value p11) 128) (= (value p12) 128) (= (value p13) 128) (= (value p14) 128)
        (= (value p21) 64) (= (value p22) 512) (= (value p23) 512) (= (value p24) 512)
        (= (value p31) 256) (= (value p32) 0) (= (value p33) 0) (= (value p34) 128)
        (= (value p41) 512) (= (value p42) 64) (= (value p43) 512) (= (value p44) 512)
    )
