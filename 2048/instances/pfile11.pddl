; Solution sequence: up right up left down right down left left left up
(define (problem pfile11)
    ...
    (:init
        ...
        (= (value p21) 0) (= (value p22) 64) (= (value p23) 128) (= (value p24) 64)
        (= (value p31) 64) (= (value p32) 0) (= (value p33) 512) (= (value p34) 64)
        (= (value p41) 64) (= (value p42) 1024) (= (value p43) 0) (= (value p44) 64)
    )
