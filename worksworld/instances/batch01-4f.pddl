; problem: site1-interface1-wfc4-free
; domain: worksworld-simplified
; 1 sites, 1 dpis and dsis, 4 workflow components, linear chain, free goal

(define (problem site1-interface1-wfc4-free)(:domain worksworld-simplified)
