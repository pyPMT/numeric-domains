; problem: site1-interface1-wfc32-explicit
; domain: worksworld-simplified
; 1 sites, 1 dpis and dsis, 32 workflow components, linear chain, explicit goal

(define (problem site1-interface1-wfc32-explicit)(:domain worksworld-simplified)
