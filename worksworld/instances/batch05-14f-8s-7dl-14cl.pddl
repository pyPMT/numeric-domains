; problem: wfc14-free-8s-7dl-14cl
; domain: worksworld-simplified
; 8 sites, star topology (1 cloud hub + 7 region peripherals), 7 direct links, 14 composite links, 14 workflow components, linear chain, free goal, multi-composite-link

(define (problem wfc14-free-8s-7dl-14cl)(:domain worksworld-simplified)
  ...
  (:objects
    ...
    ; workflow components
    dc0 dc1 dc2 dc3 dc4 dc5 dc6 dc7 - data_component
    dp0 dp1 dp2 dp3 dp4 dp5 dp6 - processing_component

    ; data component types:
    dt0 dt1 dt2 dt3 dt4 dt5 dt6 dt7 - data_component_type

    ; processing component types:
    pt0 pt1 pt2 pt3 pt4 pt5 pt6 - processing_component_type
  ...
  (:init
    ...
    ; dc4 - msg metrics
    (= (msg_max_rate dc4) 149) ; max possible msg/s
    
    ; dc4 - work_amounts
    (= (work_amount dc4 config) 0.000390625) ; config size in MB
    (= (work_amount dc4 storage) 654.78515625) ; storage requirements (MB): 0.001220703125 MB/msg * 149 msg/s * 3600s
    ...
    ; dc5 - msg metrics
    (= (msg_max_rate dc5) 154) ; max possible msg/s
    
    ; dc5 - work_amounts
    (= (work_amount dc5 config) 0.00056640625) ; config size in MB
    (= (work_amount dc5 storage) 638.859375) ; storage requirements (MB): 0.00115234375 MB/msg * 154 msg/s * 3600s
    ...
    ; dc6 - msg metrics
    (= (msg_max_rate dc6) 161) ; max possible msg/s
    
    ; dc6 - work_amounts
    (= (work_amount dc6 config) 0.000546875) ; config size in MB
    (= (work_amount dc6 storage) 650.9179687499999) ; storage requirements (MB): 0.001123046875 MB/msg * 161 msg/s * 3600s
    ...
    ; dc7 - msg metrics
    (= (msg_max_rate dc7) 171) ; max possible msg/s
    
    ; dc7 - work_amounts
    (= (work_amount dc7 config) 0.000703125) ; config size in MB
    (= (work_amount dc7 storage) 1094.1328125) ; storage requirements (MB): 0.00177734375 MB/msg * 171 msg/s * 3600s
    ...
    (type_of dp3 pt3)
    (= (msg_max_rate dp3) 145) ; max possible msg/s
    ...
    (type_of dp6 pt6)
    (= (msg_max_rate dp6) 168) ; max possible msg/s
    ...
    (= (network_latency link-cloud1-region2) 0.027) ; 27ms
    ...
    (= (network_latency link-cloud1-region3) 0.030) ; 29ms
    ...
    (= (network_latency link-cloud1-region4) 0.034) ; 34ms
    ...
    (= (network_latency link-cloud1-region5) 0.027) ; 26ms
    ...
    (= (network_latency composite-region1-region2) 0.052) ; 51ms (sum of sub-links)
    ...
    (= (network_latency composite-region1-region3) 0.054) ; 53ms (sum of sub-links)
    ...
    (= (network_latency composite-region1-region4) 0.059) ; 58ms (sum of sub-links)
    ...
    (= (network_latency composite-region1-region5) 0.051) ; 51ms (sum of sub-links)
    ...
    (= (network_latency composite-region1-region6) 0.059) ; 59ms (sum of sub-links)
    ...
    (= (network_latency composite-region1-region7) 0.053) ; 53ms (sum of sub-links)
    ...
    (= (network_latency composite-region2-region3) 0.057) ; 56ms (sum of sub-links)
    ...
    (= (network_latency composite-region2-region4) 0.062) ; 61ms (sum of sub-links)
    ...
    (= (network_latency composite-region2-region5) 0.054) ; 54ms (sum of sub-links)
    ...
    (= (network_latency composite-region2-region6) 0.062) ; 62ms (sum of sub-links)
    ...
    (= (network_latency composite-region2-region7) 0.056) ; 56ms (sum of sub-links)
    ...
    (= (network_latency composite-region3-region4) 0.064) ; 63ms (sum of sub-links)
    ...
    (= (network_latency composite-region3-region5) 0.057) ; 56ms (sum of sub-links)
    ...
    (= (network_latency composite-region3-region6) 0.065) ; 64ms (sum of sub-links)
  ...
  (:goal
    ...
    (and
      (exists (?dsi - dsi)
        (and
          (has_data dc7 ?dsi dc0 dsi-region1)
        )
      )
