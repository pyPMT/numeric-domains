; problem: site1-wfc2-free-2i
; domain: worksworld-simplified
; 1 site, 2 dpis and dsis per site, 2 workflow components, linear chain, free goal, multi-interface

(define (problem site1-wfc2-free-2i)(:domain worksworld-simplified)
  ...
  (:objects
    ...
    ; Multi-interface mode: 2 interfaces per site
    dpi-cloud1-1 dpi-cloud1-2 - dpi
    dsi-cloud1-1 dsi-cloud1-2 - dsi
  ...
  (:goal
    ...
    (and
      (has_data dc1 dsi-cloud1-2 dc0 dsi-cloud1-1)
