; problem: site4-wfc2-free-4s
; domain: worksworld-simplified
; 4 sites, star topology (1 cloud hub + 3 region peripherals), 2 workflow components, linear chain, free goal, multi-site

(define (problem site4-wfc2-free-4s)(:domain worksworld-simplified)

  (:objects
    ; sites: tractability-test hierarchical structure
    ; Clouds sites
    cloud1 - site    ; Regions sites
    region1 region2 region3 - site
    ; workflow components
    ...
    link-cloud1-cloud1 link-region1-region1 link-cloud1-region1 link-region2-region2 link-cloud1-region2 link-region3-region3 link-cloud1-region3 - direct_link
    ...
    dpi-region1 dpi-region2 dpi-region3 - dpi
    dsi-region1 dsi-region2 dsi-region3 - dsi    
  )
  ...
  (:init
    ...
    (= (network_latency link-cloud1-region1) 0.035) ; 34ms
    ...
    (= (network_latency link-cloud1-region2) 0.033) ; 33ms
    ...
    (= (network_latency link-cloud1-region3) 0.032) ; 31ms
