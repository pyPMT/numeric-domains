; problem: site1-interface1-wfc2-explicit
; domain: worksworld-simplified
; 1 sites, 1 dpis and dsis, 2 workflow components, linear chain, explicit goal

(define (problem site1-interface1-wfc2-explicit)(:domain worksworld-simplified)
  ...
  (:goal
    ...
    (and
      ...
      (has_data dc1 dsi-cloud1 dc0 dsi-cloud1)
