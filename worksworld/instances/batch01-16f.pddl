; problem: site1-interface1-wfc16-free
; domain: worksworld-simplified
; 1 sites, 1 dpis and dsis, 16 workflow components, linear chain, free goal

(define (problem site1-interface1-wfc16-free)(:domain worksworld-simplified)
