; problem: site1-wfc2-free-4l
; domain: worksworld-simplified
; 1 site, 4 intrasite links, 2 workflow components, linear chain, free goal, multi-link

(define (problem site1-wfc2-free-4l)(:domain worksworld-simplified)
  ...
  (:objects
    ...
    link-cloud1-cloud1-1 link-cloud1-cloud1-2 link-cloud1-cloud1-3 link-cloud1-cloud1-4 - direct_link
  ...
  (:init
    ...
    (= (network_latency link-cloud1-cloud1-1) 0.008) ; 7ms
    ; Direct link - Intrasite link at cloud1
    ...
    (= (network_latency link-cloud1-cloud1-4) 0.001) ; 1ms
