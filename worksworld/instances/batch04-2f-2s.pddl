; problem: site2-wfc2-free-2s
; domain: worksworld-simplified
; 2 sites, star topology (1 cloud hub + 1 region peripherals), 2 workflow components, linear chain, free goal, multi-site

(define (problem site2-wfc2-free-2s)(:domain worksworld-simplified)
  ...
  (:objects
    ...
    link-cloud1-cloud1 link-region1-region1 link-cloud1-region1 - direct_link
