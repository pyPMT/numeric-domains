; problem: site16-wfc2-free-16s
; domain: worksworld-simplified
; 16 sites, star topology (1 cloud hub + 15 region peripherals), 2 workflow components, linear chain, free goal, multi-site

(define (problem site16-wfc2-free-16s)(:domain worksworld-simplified)

  (:objects
    ; sites: tractability-test hierarchical structure
    ; Clouds sites
    cloud1 - site    ; Regions sites
    region1 region2 region3 region4 region5 region6 region7 region8 region9 region10 region11 region12 region13 region14 region15 - site
    ; workflow components
    ...
    link-cloud1-cloud1 link-region1-region1 link-cloud1-region1 link-region2-region2 link-cloud1-region2 link-region3-region3 link-cloud1-region3 link-region4-region4 link-cloud1-region4 link-region5-region5 link-cloud1-region5 link-region6-region6 link-cloud1-region6 link-region7-region7 link-cloud1-region7 link-region8-region8 link-cloud1-region8 link-region9-region9 link-cloud1-region9 link-region10-region10 link-cloud1-region10 link-region11-region11 link-cloud1-region11 link-region12-region12 link-cloud1-region12 link-region13-region13 link-cloud1-region13 link-region14-region14 link-cloud1-region14 link-region15-region15 link-cloud1-region15 - direct_link
    ...
    dpi-region1 dpi-region2 dpi-region3 dpi-region4 dpi-region5 dpi-region6 dpi-region7 dpi-region8 dpi-region9 dpi-region10 dpi-region11 dpi-region12 dpi-region13 dpi-region14 dpi-region15 - dpi
    dsi-region1 dsi-region2 dsi-region3 dsi-region4 dsi-region5 dsi-region6 dsi-region7 dsi-region8 dsi-region9 dsi-region10 dsi-region11 dsi-region12 dsi-region13 dsi-region14 dsi-region15 - dsi    
  )
  ...
  (:init
    ...
    ; dc1 - msg metrics
    (= (msg_max_rate dc1) 127) ; max possible msg/s
    
    ; dc1 - work_amounts
    (= (work_amount dc1 config) 0.000517578125) ; config size in MB
    (= (work_amount dc1 storage) 683.12109375) ; storage requirements (MB): 0.001494140625 MB/msg * 127 msg/s * 3600s
    ...
    (= (network_latency link-cloud1-region1) 0.025) ; 24ms
    ...
    (= (network_latency link-cloud1-region3) 0.031) ; 30ms
    ...
    (= (network_latency link-cloud1-region4) 0.032) ; 32ms
    ...
    (= (network_latency link-cloud1-region5) 0.029) ; 29ms
    ...
    (= (network_latency link-cloud1-region6) 0.026) ; 25ms
    ...
    (= (network_latency link-cloud1-region7) 0.027) ; 26ms
    ...
    (= (network_latency link-cloud1-region8) 0.021) ; 21ms
    ...
    (= (network_latency link-cloud1-region10) 0.028) ; 28ms
    ...
    (= (network_latency link-cloud1-region11) 0.034) ; 33ms
    ...
    (= (network_latency link-cloud1-region14) 0.026) ; 26ms
    ...
    (= (network_latency link-cloud1-region15) 0.024) ; 23ms
