; problem: site1-wfc2-free-8i
; domain: worksworld-simplified
; 1 site, 8 dpis and dsis per site, 2 workflow components, linear chain, free goal, multi-interface

(define (problem site1-wfc2-free-8i)(:domain worksworld-simplified)
  ...
  (:objects
    ...
    ; Multi-interface mode: 8 interfaces per site
    dpi-cloud1-1 dpi-cloud1-2 dpi-cloud1-3 dpi-cloud1-4 dpi-cloud1-5 dpi-cloud1-6 dpi-cloud1-7 dpi-cloud1-8 - dpi
    dsi-cloud1-1 dsi-cloud1-2 dsi-cloud1-3 dsi-cloud1-4 dsi-cloud1-5 dsi-cloud1-6 dsi-cloud1-7 dsi-cloud1-8 - dsi
  ...
  (:goal
    ...
    (and
      (has_data dc1 dsi-cloud1-8 dc0 dsi-cloud1-1)
