; problem: site1-interface1-wfc64-explicit
; domain: worksworld-simplified
; 1 sites, 1 dpis and dsis, 64 workflow components, linear chain, explicit goal

(define (problem site1-interface1-wfc64-explicit)(:domain worksworld-simplified)
