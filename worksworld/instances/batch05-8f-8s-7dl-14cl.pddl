; problem: wfc8-free-8s-7dl-14cl
; domain: worksworld-simplified
; 8 sites, star topology (1 cloud hub + 7 region peripherals), 7 direct links, 14 composite links, 8 workflow components, linear chain, free goal, multi-composite-link

(define (problem wfc8-free-8s-7dl-14cl)(:domain worksworld-simplified)
  ...
  (:init
    ...
    ; dc3 - msg metrics
    (= (msg_max_rate dc3) 130) ; max possible msg/s
    
    ; dc3 - work_amounts
    (= (work_amount dc3 config) 0.000615234375) ; config size in MB
    (= (work_amount dc3 storage) 648.984375) ; storage requirements (MB): 0.00138671875 MB/msg * 130 msg/s * 3600s
    ...
    (type_of dp2 pt2)
    (= (msg_max_rate dp2) 127) ; max possible msg/s
    ...
    (type_of dp3 pt3)
    (= (msg_max_rate dp3) 134) ; max possible msg/s
    ...
    (= (network_latency link-cloud1-region2) 0.032) ; 31ms
    ...
    (= (network_latency link-cloud1-region3) 0.029) ; 29ms
    ...
    (= (network_latency link-cloud1-region4) 0.027) ; 27ms
    ...
    (= (network_latency link-cloud1-region5) 0.024) ; 24ms
    ...
    (= (network_latency link-cloud1-region6) 0.026) ; 26ms
    ...
    (= (network_latency composite-region1-region2) 0.053) ; 53ms (sum of sub-links)
    ...
    (= (network_latency composite-region1-region3) 0.051) ; 50ms (sum of sub-links)
    ...
    (= (network_latency composite-region1-region4) 0.049) ; 48ms (sum of sub-links)
    ...
    (= (network_latency composite-region1-region5) 0.046) ; 45ms (sum of sub-links)
    ...
    (= (network_latency composite-region1-region6) 0.048) ; 47ms (sum of sub-links)
    ...
    (= (network_latency composite-region1-region7) 0.046) ; 45ms (sum of sub-links)
    ...
    (= (network_latency composite-region2-region3) 0.061) ; 61ms (sum of sub-links)
    ...
    (= (network_latency composite-region2-region4) 0.059) ; 58ms (sum of sub-links)
    ...
    (= (network_latency composite-region2-region5) 0.056) ; 56ms (sum of sub-links)
    ...
    (= (network_latency composite-region2-region6) 0.058) ; 58ms (sum of sub-links)
    ...
    (= (network_latency composite-region3-region4) 0.056) ; 56ms (sum of sub-links)
    ...
    (= (network_latency composite-region3-region5) 0.054) ; 53ms (sum of sub-links)
    ...
    (= (network_latency composite-region3-region6) 0.055) ; 55ms (sum of sub-links)
  ...
  (:goal
    ...
    (and
      (exists (?dsi - dsi)
        (and
          (has_data dc4 ?dsi dc0 dsi-region1)
        )
      )
