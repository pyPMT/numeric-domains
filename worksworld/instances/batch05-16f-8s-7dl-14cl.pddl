; problem: wfc16-free-8s-7dl-14cl
; domain: worksworld-simplified
; 8 sites, star topology (1 cloud hub + 7 region peripherals), 7 direct links, 14 composite links, 16 workflow components, linear chain, free goal, multi-composite-link

(define (problem wfc16-free-8s-7dl-14cl)(:domain worksworld-simplified)
  ...
  (:init
    ...
    ; dc4 - msg metrics
    (= (msg_max_rate dc4) 144) ; max possible msg/s
    
    ; dc4 - work_amounts
    (= (work_amount dc4 config) 0.000390625) ; config size in MB
    (= (work_amount dc4 storage) 632.8125) ; storage requirements (MB): 0.001220703125 MB/msg * 144 msg/s * 3600s
    ...
    ; dc5 - msg metrics
    (= (msg_max_rate dc5) 148) ; max possible msg/s
    
    ; dc5 - work_amounts
    (= (work_amount dc5 config) 0.00056640625) ; config size in MB
    (= (work_amount dc5 storage) 613.96875) ; storage requirements (MB): 0.00115234375 MB/msg * 148 msg/s * 3600s
    ...
    ; dc6 - msg metrics
    (= (msg_max_rate dc6) 150) ; max possible msg/s
    
    ; dc6 - work_amounts
    (= (work_amount dc6 config) 0.000546875) ; config size in MB
    (= (work_amount dc6 storage) 606.4453125) ; storage requirements (MB): 0.001123046875 MB/msg * 150 msg/s * 3600s
    ...
    ; dc7 - msg metrics
    (= (msg_max_rate dc7) 160) ; max possible msg/s
    
    ; dc7 - work_amounts
    (= (work_amount dc7 config) 0.000703125) ; config size in MB
    (= (work_amount dc7 storage) 1023.75) ; storage requirements (MB): 0.00177734375 MB/msg * 160 msg/s * 3600s
    ...
    ; dc8 - msg metrics
    (= (msg_max_rate dc8) 163) ; max possible msg/s
    
    ; dc8 - work_amounts
    (= (work_amount dc8 config) 0.000712890625) ; config size in MB
    (= (work_amount dc8 storage) 595.96875) ; storage requirements (MB): 0.001015625 MB/msg * 163 msg/s * 3600s
    ...
    (type_of dp1 pt1)
    (= (msg_max_rate dp1) 127) ; max possible msg/s
    ...
    (type_of dp6 pt6)
    (= (msg_max_rate dp6) 154) ; max possible msg/s
    ...
    (type_of dp7 pt7)
    (= (msg_max_rate dp7) 160) ; max possible msg/s
    ...
    (= (network_latency link-cloud1-region1) 0.029) ; 29ms
    ...
    (= (network_latency link-cloud1-region2) 0.021) ; 21ms
    ...
    (= (network_latency link-cloud1-region3) 0.030) ; 30ms
    ...
    (= (network_latency link-cloud1-region4) 0.021) ; 20ms
    ...
    (= (network_latency link-cloud1-region5) 0.026) ; 25ms
    ...
    (= (network_latency link-cloud1-region6) 0.035) ; 34ms
    ...
    (= (network_latency link-cloud1-region7) 0.023) ; 23ms
    ...
    (= (network_latency composite-region1-region2) 0.051) ; 50ms (sum of sub-links)
    ...
    (= (network_latency composite-region1-region3) 0.059) ; 59ms (sum of sub-links)
    ...
    (= (network_latency composite-region1-region4) 0.050) ; 49ms (sum of sub-links)
    ...
    (= (network_latency composite-region1-region5) 0.055) ; 54ms (sum of sub-links)
    ...
    (= (network_latency composite-region1-region6) 0.064) ; 64ms (sum of sub-links)
    ...
    (= (network_latency composite-region1-region7) 0.052) ; 52ms (sum of sub-links)
    ...
    (= (network_latency composite-region2-region3) 0.052) ; 51ms (sum of sub-links)
    ...
    (= (network_latency composite-region2-region4) 0.042) ; 41ms (sum of sub-links)
    ...
    (= (network_latency composite-region2-region5) 0.047) ; 47ms (sum of sub-links)
    ...
    (= (network_latency composite-region2-region6) 0.056) ; 56ms (sum of sub-links)
    ...
    (= (network_latency composite-region2-region7) 0.045) ; 44ms (sum of sub-links)
    ...
    (= (network_latency composite-region3-region4) 0.051) ; 50ms (sum of sub-links)
    ...
    (= (network_latency composite-region3-region5) 0.056) ; 56ms (sum of sub-links)
    ...
    (= (network_latency composite-region3-region6) 0.065) ; 65ms (sum of sub-links)
  ...
  (:goal
    ...
    (and
      (exists (?dsi - dsi)
        (and
          (has_data dc8 ?dsi dc0 dsi-region1)
        )
      )
