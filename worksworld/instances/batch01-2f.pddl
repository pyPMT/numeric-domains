; problem: site1-interface1-wfc2-free
; domain: worksworld-simplified
; 1 sites, 1 dpis and dsis, 2 workflow components, linear chain, free goal

(define (problem site1-interface1-wfc2-free)(:domain worksworld-simplified)
